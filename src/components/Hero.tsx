...
const Hero = () => {
  return (
    <section className="relative py-8 md:py-16 px-4 md:px-8 text-center border-b-2 border-[var(--primary)] bg-[#040504]">
      ...
      <p className="text-lg md:text-xl mb-2 text-[var(--primary)]">
        Votre partenaire d'affaires innovant
      </p>
      ...
      <div className="w-full max-w-2xl mx-auto aspect-video bg-[#040504]">
        <iframe
          src="https://drive.google.com/file/d/1Fej2Q3z6rtYeUESUQjdRiYP6EsW7_0Ay/preview"
          className="w-full h-full border-4 border-[var(--primary)] rounded-lg bg-[#040504]"
