...
const Services = () => {
  return (
    <section className="py-8 md:py-16 px-4 md:px-8 bg-[#040504] border-b border-[var(--primary)]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8 max-w-6xl mx-auto">
        <div className="bg-[#040504] p-4 md:p-8 rounded-lg shadow-lg border border-[var(--primary)] hover:-translate-y-2 transition-transform duration-300">
